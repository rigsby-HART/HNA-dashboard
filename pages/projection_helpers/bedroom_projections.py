...
def projections_future_hh_size(geo, IsComparison, language, year: int = default_year):
    ...
    for income in income_ids:
        for bed in bedoom_count:
            col_format = f"2031 Projected bedroom need {bed} bed {income}"
...
@callback(
    Output('bedroom-projection-table', 'columns'),
    Output('bedroom-projection-table', 'data'),
    Output('bedroom-projection-table', 'style_data_conditional'),
    Output('bedroom-projection-table', 'style_cell_conditional'),
    Output('bedroom-projection-table', 'style_header_conditional'),
    Output('bedroom-projection-graph', 'figure'),
    Input('main-area', 'data'),
    Input('comparison-area', 'data'),
    Input('area-scale-store', 'data'),
    Input('bedroom-projection-table', 'selected_columns'),
    State('url', 'search'),
