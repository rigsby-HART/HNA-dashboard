...
def update_geo_figure_h(geo, geo_c, scale, selected_columns):
    ...
    # Comparison mode
        ...
        fig_csd = make_subplots(rows=1, cols=2, subplot_titles=(f"{geo}", f"{geo_c}"), shared_yaxes=True,
                                shared_xaxes=True)
...
def update_geo_figure8(geo, geo_c, scale, selected_columns):
    ...
    # Comparison mode
        ...
        fig_pgr = make_subplots(rows=1, cols=2, subplot_titles=(f"{geo}", f"{geo_c}"), shared_yaxes=True,
                                shared_xaxes=True)
