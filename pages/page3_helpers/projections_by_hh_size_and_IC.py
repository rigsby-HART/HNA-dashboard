...
@callback(
    Output('projected-hh-by-hh-size-income', 'columns'),
    Output('projected-hh-by-hh-size-income', 'data'),
    Output('projected-hh-by-hh-size-income', 'style_data_conditional'),
    Output('projected-hh-by-hh-size-income', 'style_cell_conditional'),
    Output('projected-hh-by-hh-size-income', 'style_header_conditional'),
